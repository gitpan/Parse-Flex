# This Makefile is for the Parse::Flex extension to perl.
#
...
#	ABSTRACT_FROM => q[Flex.pm]
#	AUTHOR => q[Ioannis Tambouras <ioannis@earthlink.net>]
#	CCFLAGS => q[ -DDEBIAN -fno-strict-aliasing -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -D_REENTRANT ]
#	MYEXTLIB => q[src/libflexer.a]
#	NAME => q[Parse::Flex]
#	NORECURS => q[0]
#	PREREQ_PM => { Test::More=>q[0] }
#	VERSION_FROM => q[Flex.pm]
...
CCFLAGS =  -DDEBIAN -fno-strict-aliasing -I/usr/local/include -D_LARGEFILE_SOURCE -D_FILE_OFFSET_BITS=64  -D_REENTRANT 
OPTIMIZE = -O2
PERLTYPE = 
MPOLLUTE = 
...
# Parse::Flex might depend on some other libraries:
...
manifypods : pure_all Flex.pm
	@$(POD2MAN) \
	Flex.pm \
	$(INST_MAN3DIR)/Parse::Flex.$(MAN3EXT)
...
clean ::
	-cd src && $(TEST_F) Makefile && $(MAKE) clean
	-rm -rf Flex.c ./blib $(MAKE_APERL_FILE) $(INST_ARCHAUTODIR)/extralibs.all perlmain.c mon.out core core.*perl.*.? *perl.core so_locations pm_to_blib *$(OBJ_EXT) *$(LIB_EXT) perl.exe $(BOOTSTRAP) $(BASEEXT).bso $(BASEEXT).def $(BASEEXT).exp
...
realclean purge ::  clean
	-cd src && $(TEST_F) Makefile.old && $(MAKE) -f Makefile.old realclean
	-cd src && $(TEST_F) Makefile && $(MAKE)  realclean
	rm -rf $(INST_AUTODIR) $(INST_ARCHAUTODIR)
	rm -f $(INST_DYNAMIC) $(INST_BOOT)
	rm -f $(INST_STATIC)
	rm -f  $(INST_LIBDIR)/Flex.pm
...
test :: $(TEST_TYPE)
	@cd src && $(TEST_F) Makefile && $(MAKE) test $(PASTHRU)
...
ppd:
	@$(PERL) -e "print qq{<SOFTPKG NAME=\"Parse-Flex\" VERSION=\"0,01,0,0\">\n}. qq{\t<TITLE>Parse-Flex</TITLE>\n}. qq{\t<ABSTRACT>The Fastest Lexer on the West   **Development Release**</ABSTRACT>\n}. qq{\t<AUTHOR>Ioannis Tambouras &lt;ioannis\@earthlink.net&gt;</AUTHOR>\n}. qq{\t<IMPLEMENTATION>\n}. qq{\t\t<DEPENDENCY NAME=\"Test-More\" VERSION=\"0,0,0,0\" />\n}. qq{\t\t<OS NAME=\"$(OSNAME)\" />\n}. qq{\t\t<ARCHITECTURE NAME=\"i386-linux\" />\n}. qq{\t\t<CODEBASE HREF=\"\" />\n}. qq{\t</IMPLEMENTATION>\n}. qq{</SOFTPKG>\n}" > Parse-Flex.ppd
